...
export default function Achievements() {
  ...
  return (
    <>
      <Header />
      <div className="relative min-h-screen bg-gradient-to-b from-black via-[#0a0a0a] to-[#111] pt-24 pb-24 overflow-x-hidden flex flex-col gap-10 px-2 sm:px-4">
        {/* Green glow */}
        ...
        <motion.h1
          ...
          className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white to-[#22c55e] drop-shadow-[0_0_15px_rgba(34,197,94,0.4)] text-center"
        >
          Achievements
        </motion.h1>
